...
independent = dataset[['purchase_frequency','spending']].values
X = independent
# Dependent varible(Target) = loyal customer.
dependent = dataset['loyalty'].values
y = dependent

#-------------------------------------------------------------
# Data cleaning 
# Convert the 'spending' column into binary categories for classification
